...
def extract_coauthors(output_dir, filename):
    ...
    for block in tqdm(coauthors_blocks):
        ...
        author2coauthor[author1].append({"coauthor_id": author2, "weight": weight})

        author2coauthor[author2].append({"coauthor_id": author1, "weight": weight})
